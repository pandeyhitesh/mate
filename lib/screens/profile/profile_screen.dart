...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Profile', style: textStyle2,),
      ),
  ...
  Widget profilePhoto() {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(blurRadius: 10.0, color: greyDeep, spreadRadius: 5)
          ]),
    );
  }
}
      ...
      children: [
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                      blurRadius: 5, color: Colors.grey[400], spreadRadius: 1)
                ]),
            child: Center(
                child: Text(
              'f',
        ...
        Container(
          ...
          child: Center(
              child: Text(
            'G',
            style: fbTextStyle.copyWith(color: Colors.yellow[800]),
          )),
        ),
        Container(
          padding: EdgeInsets.only(top: 5),
...
Widget postContainer(BuildContext context, BlogModel blog) {
  return Container(
    ...
    decoration: BoxDecoration(
      ...
      boxShadow: [
        BoxShadow(blurRadius: 5, color: Colors.grey[400], spreadRadius: 5),
      ],
    ),
    child: Column(
      mainAxisAlignment: MainAxisAlignment.start,
